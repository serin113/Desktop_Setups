...
text_settings = {
	...
	{ -- current minute text
		...
		alpha=1,
		center=true,
		x=clock_text_x, y=clock_text_y+12,
		theta=0,
		h_align='center',
		v_align='middle'
	...
	{ -- current workspace text
		...
		alpha=1,
		center=true,
		x=desk_text_x, y=desk_text_y + 100,
		theta=0,
		h_align='center',
		v_align='middle'
	...
	{ -- title
		...
		alpha=1,
		center=true,
		x=clock_text_x - 70, y=clock_text_y - 90,
		theta=0,
		h_align='left',
		v_align='middle'
	}, -- end title
	...
	{ -- music text
		name='${exec ~/scripts/song_deadbeef artist 60}',
		arg='',
		parse_as_is=true,
		font='Myriad Pro',
		bold=false,
		...
		alpha=1,
		center=true,
		x=clock_text_x - 60, y=clock_text_y - 70,
		theta=0,
		h_align='left',
		v_align='middle'
	}, -- end music text
	...
	{ -- note text
		name='${exec head -n 1 /home/serin/.local/share/notes/Notes/Notes}',
		arg='',
		parse_as_is=true,
		font='Myriad Pro',
		bold=false,
		...
		alpha=1,
		center=true,
		x=clock_text_x - 70, y=clock_text_y - 200,
		theta=0,
		h_align='center',
		v_align='middle'
	}, -- end note text
